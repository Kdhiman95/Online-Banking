        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                <div class="sidebar-brand-icon">
                    <img src="img/Logo3.png" alt="" class="img-fluid" width="30" height="30">
                </div>
                <div class="sidebar-brand-text mx-3">Sky Bank</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="transaction.php">
                    ...
                    <span> &nbsp Transaction History</span>
                </a>
            </li>
            ...
            <li class="nav-item active">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-motherboard-fill" viewBox="0 0 16 16">
                    ...
                    <span> &nbsp Others</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Others</h6>
                        <a class="collapse-item" href="card.php">Cards</a>
                        <a class="collapse-item" href="profile.php">Settings</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-0">
                        <h1 class="h2 mb-0 text-gray-800"><?php echo $_SESSION['username']; ?></h1>
                    </div>

                    <!-- Topbar Navbar -->
                    <ul class="navbar-nav ml-auto">
                        <li class="d-sm-flex align-items-center justify-content-between mb-0">
                            Account number:
