...
include "header.php";
?>
<section id="hero" class="d-flex align-items-center" style="height:1px;"></section>
    <section class="inner-page">
      <div class="container">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Sky Bank, Sky Tower New Mumbai.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Sky Bank, accessible from <a href="http://www.skybank.com" rel="external nofollow noopener" target="_blank">http://www.skybank.com</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: skybank2020@gmail.com</li>
        </ul>
      </div>
    </section>
<?php
