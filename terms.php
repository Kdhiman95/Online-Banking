...
<div class="term">
    <section class="inner-page">
        <div class="container">
            ...
            <p>These terms and conditions outline the rules and regulations for the use of Sky Bank's Website, located
                at skybank.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Sky
                Bank if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing Sky Bank, you agreed to use cookies in agreement with the Sky
                Bank's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Sky Bank and/or its licensors own the intellectual property rights for all
                material on Sky Bank. All intellectual property rights are reserved. You may access this from Sky Bank
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Sky Bank does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of Sky Bank,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, Sky Bank shall not be liable for the Comments or for any
            ...
            <p>Sky Bank reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Sky Bank a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Sky Bank; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Sky Bank. Please include your name, your
            ...
            <p>No use of Sky Bank's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
