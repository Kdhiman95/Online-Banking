        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="getstarted scrollto" href="after index page/register.php">Sign Up </a></li>
                    <li><a class="getstarted scrollto" href="after index page/login.php">Login</a></li>
                </ul>
