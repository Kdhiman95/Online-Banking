    ...
    <div class="container-fluid" data-aos="fade-up">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <div class="heroBtn">
                    <div><a href="after index page/register.php" class="btn-get-started scrollto">Sign Up</a></div>
                    <div><a href="after index page/login.php" class="btn-get-started scrollto">Login</a></div>
                </div>
...
<main id="main">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
                    <h3>3 Step Banking System</h3>
                    <p class="font-italic">
                        You just need to follow 3 steps to start banking with us. Lets introduce to you with account
                        creation
                        steps.
                    </p>
                    <ul>
                        <li><i class="bi bi-check-circle"></i> Click on Sign Up.</li>
    ...
    <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Services</h2>
                <p>We Provide Worlds Best Baking Services to our Customer. We use the secure and powerful server for
                    safe
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box iconbox-pink">
                        ...
                        <p>Our Bank allows there customer to access their account 24/7 without having to visit a
                            physical branch
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <p>
                                ...
                                Sky Bank is the best bank for Monitoring account it provide data in graphical manner
                                from that can we
                                understand our account is in profit or loss. Also i use saving option which is
                                wonderful.
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                The Transaction system of the sky bank is very fast. We can easily manage our
                                transaction history
                ...
                <ul>
                    <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                            <p>
                                You just need to follow 3 steps to start banking with us. Lets introduce to you with
                                account creation
                                steps. <br>

                                1 Click on Sign Up. <br>
                                2 Fill Basic Details <br>
                    ...
                    <li data-aos="fade-up" data-aos-delay="300">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                            data-bs-target="#faq-list-3" class="collapsed">How to view the transaction history ?<i
                                class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                        <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                ...
                                3 click on Transaction History Option <br>
                            </p>
                        </div>
                    </li>
                    ...
                    <li data-aos="fade-up" data-aos-delay="400">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                            data-bs-target="#faq-list-4" class="collapsed">How to apply for credit card and debit card ?
    ...
    <!-- =====about section===== -->
    <section id="about" class="bg-light-blue pt-5 pb-5">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4 d-flex">
                            <div class="card mb-3">
                                ...
                                <div class="card-footer pt-0 border-top-0">
                                    <a href="#">kamal.dhiman2001@gmail.com</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 d-flex">
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="card mb-3">
                                ...
                                <div class="card-footer pt-0 border-top-0">
                                    <a href="#">harmunish.taneja@gmail.com </a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="contact" class="contact section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Contact</h2>
                <p>For Any query related to bank or account please contact us. We are trying to solve your all problems
                </p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="info-box mb-4">
                        <i class="bx bx-map"></i>
                        <h3>Our Address</h3>
                        <p>DAV college<br>Sector-10, Chandigarh<br></p>
                    </div>
                </div>
